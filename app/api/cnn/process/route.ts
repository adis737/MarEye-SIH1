...
`
      ...
      if (pythonResult.code !== 0) {
        console.error("Enhancement error:", pythonResult.stderr)
      ...
      try {
        ...
        return NextResponse.json({ 
          ...
          details: `Parse error: ${parseError.message}, Raw output: ${pythonResult.stdout}`
        }, { status: 500 })
      }
    ...
    if len(sys.argv) >= 3:
        ...
        try {
          ...
          return NextResponse.json({ 
            ...
            details: `Parse error: ${parseError.message}, Raw output: ${opencvResult.stdout}`
          }, { status: 500 })
        }
      }
